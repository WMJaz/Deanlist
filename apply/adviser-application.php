                                ...
                                <table class="table" id="pendingTable">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <div class="modal fade" id="viewModal<?php echo $row["id"] ?>" tabindex="-1" aria-labelledby="viewModal<?php echo $row["id"] ?>" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
